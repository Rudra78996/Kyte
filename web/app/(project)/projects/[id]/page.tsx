  ...
  return (
    <div className="min-h-screen bg-[#000] text-gray-100 font-sans selection:bg-[#fff] selection:text-[#000] pb-24">
      ...
      <div className="px-8 mt-12 max-w-[1600px] mx-auto w-full">
              ...
              <div className="border border-[#1E1E1E] rounded-xl bg-[#0A0A0A] overflow-hidden">
                ...
                <div className="p-4 flex flex-col gap-4 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-200 font-mono text-[11px] tracking-tight bg-[#111] px-1.5 py-0.5 rounded border border-[#222]">Next.js</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">Build cmd</span>
                    <span className="text-gray-200 font-mono text-[11px] tracking-tight bg-[#111] px-1.5 py-0.5 rounded border border-[#222]">npm run build</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">Output dir</span>
                    <span className="text-gray-200 font-mono text-[11px] tracking-tight bg-[#111] px-1.5 py-0.5 rounded border border-[#222]">.next</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">Install cmd</span>
                    <span className="text-gray-200 font-mono text-[11px] tracking-tight bg-[#111] px-1.5 py-0.5 rounded border border-[#222]">npm install</span>
                  </div>
                </div>
              </div>
        ...
        {["Analytics", "Environment", "Domains", "Settings"].includes(activeTab) && (
