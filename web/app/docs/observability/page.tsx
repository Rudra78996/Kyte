...
const metrics = [
  { title: "Traffic", detail: "Pageviews and unique visitors across the selected time range.", icon: Activity },
  { title: "Traffic location", detail: "A country-level breakdown of where visitors reach your project.", icon: MapPinned },
  { title: "Response time", detail: "The average time visitors wait for a production response.", icon: Gauge },
...
export default function ObservabilityDocs() {
  return (
    <article className="animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      <section className="mt-10 border-t border-border pt-8"><h2 className="text-lg font-semibold tracking-[-0.02em]">Open it from any project</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">Choose the Observability tab in project details to move from the overview summary into the seven-day chart, location table, response time, build duration, and deployment success rate.</p></section>
    </article>
  );
}
